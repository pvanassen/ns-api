...
//        assertThat(verstoringen).hasSize(2);
//        assertEquals(2, verstoringen.getOngeplandeStoringen().size());
//        Storing deurne = verstoringen.getOngeplandeStoringen().get(0);
...
//        assertEquals(0, verstoringen.getGeplandeStoringen().size());
    }
