...
public class ReisadviesHandleTest {
    ...
    public void testGetModel() {
        ...
        assertEquals("Fri Dec 27 17:54:00 CET 2013", intercity.getGeplandeAankomstTijd().toString());
        assertEquals("Fri Dec 27 17:54:00 CET 2013", intercity.getActueleAankomstTijd().toString());
        assertNull(intercity.getAankomstVertraging());
        assertEquals("Fri Dec 27 16:20:00 CET 2013", intercity.getGeplandeVertrekTijd().toString());
        assertEquals("Fri Dec 27 16:20:00 CET 2013", intercity.getActueleVertrekTijd().toString());
        ...
        assertEquals("Fri Dec 27 16:20:00 CET 2013", utrecht.getTijd().toString());
