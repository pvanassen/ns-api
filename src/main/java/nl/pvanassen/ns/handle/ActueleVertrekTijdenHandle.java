    ...
    public ActueleVertrekTijden getModel(InputStream stream) {
        ...
        try {
            ...
            for (Xml vertrekkendeTreinXml : xml.children("VertrekkendeTrein")) {
                ...
                vertrekkendeTreinen.add(new VertrekkendeTrein(ritNummer, vertrekTijd, vertrekVertraging, vertrekVertragingTekst, eindBestemming, treinSoort, routeTekst, vervoerder, vertrekSpoor, gewijzigdVertrekspoor, reisTip, opmerkingen));
            }
