    ...
    public ActueleVertrekTijden getModel(InputStream stream) {
        ...
        try {
            ...
            for (Xml vertrekkendeTreinXml : xml.children("VertrekkendeTrein")) {
        		...
        		Integer vertrekVertragingMinuten = null;
        		if (vertrekVertraging != null && !vertrekVertraging.isEmpty()) {
        			try {
        				vertrekVertragingMinuten = Integer.valueOf(vertrekVertraging.replace("PT", "").replace("M", ""));
        			}
                ...
                boolean gewijzigdVertrekspoor = Boolean.valueOf(vertrekkendeTreinXml.child("VertrekSpoor").string("wijziging"));
                ...
                vertrekkendeTreinen.add(new VertrekkendeTrein(ritNummer, vertrekTijd, vertrekVertraging, vertrekVertragingMinuten, vertrekVertragingTekst, eindBestemming, treinSoort, routeTekst, vervoerder, vertrekSpoor, gewijzigdVertrekspoor, reisTip, opmerkingen));
            }
